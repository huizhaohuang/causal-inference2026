...
dag_complex2 <- dagitty("dag {
  ...
  # Observed pre-treatment confounder:
  U1 -> D
  U1 -> Y

  # Upstream driver of U1 and Y (deeper structure / measurement issues):
  U2 -> U1
  U2 -> Y
}")

ggdag(dag_complex2, text = FALSE) + theme_dag()
```
...
dseparated(dag_complex2, "D", "Y", c("U1","M"))   # TRUE (but note: conditioning on M changes estimand)
```
